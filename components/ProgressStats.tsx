 ...
 * Displays real-time productivity statistics and task completion metrics
...
const ProgressStats = () => {
    ...
    // Real-time query to fetch all todos from database
    // Automatically updates when todos are added, completed, or deleted
    const todos = useQuery(api.todos.getTodos);
    
    // Calculate statistics with null safety for loading states
            ...
            <View style={settingStyles.statsContainer}>
                ...
                >
                    ...
                    <View>
                        ...
                        <Text style={settingStyles.statLabel}>Active</Text>  {/* "Active" is more positive than "Pending" */}
                    </View>
                </LinearGradient>
            </View>    
        </LinearGradient>
